...
def init_ae_model(qmap_quality=1):
    ...
    models = {
            "64": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/64_freeze.model"}, scale_factor=0.25)),
            "128": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/128_freeze.model"}, scale_factor=0.5)),
            "256": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/256_freeze.model"}, scale_factor=0.5)),
            "512": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/512_freeze.model"}, scale_factor=0.5)),
            "1024": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/1024_freeze.model"}, scale_factor=0.5)),
            "2048": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/2048_freeze.model"})),
            "4096": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/4096_freeze.model"})),
            "6144": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/6144_freeze.model"})),
            "8192": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/8192_freeze.model"})),
            "12288": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/12288_freeze.model"})),
            "16384": AEModel(GraceAdapter({"path": f"{GRACE_MODEL}/16384_freeze.model"})),
            }
...
run_one_file("INDEX.txt", "results/grace-debug")
